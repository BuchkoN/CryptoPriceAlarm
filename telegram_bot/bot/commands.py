...
async def help_command(message: types.Message):
    await message.answer(
        'Моя единственная задача, это сообщить,\
            когда курс криптовалюты достигнет нужного тебе значения.\n'
        ...
        'Для того, чтобы начать со мной работать, \
            введи команду /start и следуй простым инструкциям 👌'
    )
